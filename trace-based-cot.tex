...
\centering
\footnotesize
\definecolor{initcolor}{RGB}{255,240,245}
\definecolor{processcolor}{RGB}{240,248,255}
\definecolor{finalcolor}{RGB}{240,255,240}
...
\end{lstlisting}
&
\colorbox{errorred!8}{\parbox{0.98\linewidth}{\footnotesize
\vspace{0.1cm}
1. Initialize left=0, right=4\\
2. Calculate mid=2\\
3. Compare arr[2] with \textcolor{errorred}{\textbf{arr[1]}}\\
4. Since arr[2] \textcolor{errorred}{\textbf{>}} arr[1], move \textcolor{errorred}{\textbf{right}}\\
5. Continue until left=right\\
6. Return peak index\\[0.1cm]
\textcolor{errorred}{\xmark\ Wrong: compares wrong indices, wrong direction}
\vspace{0.1cm}
}}
&
...
\colorbox{correctgreen!8}{\parbox{0.98\linewidth}{\footnotesize
\vspace{0.1cm}
...
\colorbox{processcolor}{\parbox{0.96\linewidth}{5. Since 3\textcolor{correctgreen}{\textbf{<}}5, peak in right half $\Rightarrow$ left=2}}\\[0.05cm]
\colorbox{finalcolor}{\parbox{0.96\linewidth}{6. \textbf{Done:} left==right==2, return 2}}\\[0.05cm]
\textcolor{correctgreen}{\cmark\ Each step verified by trace values}
\vspace{0.1cm}
}}
}
\\
...
\end{tabular}
\vspace{-0.1cm}
\caption{Visual mapping between execution trace and CoT reasoning. In our trace-grounded approach (right), colored boxes show how trace sections map to CoT: \colorbox{initcolor}{pink=initialization}, \colorbox{processcolor}{blue=loop iterations}, \colorbox{finalcolor}{green=final state}. Variable values in CoT exactly match trace. LLM-generated CoT (middle) hallucinates wrong array indices and search direction with no grounding.}
