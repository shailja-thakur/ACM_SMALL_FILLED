...
\begin{abstract}
  Chain-of-Thought (CoT) fine-tuning for code suffers from a critical flaw: the reasoning steps in synthetic
     ...
     every reasoning step is a verifiable, factual account of a program's actual execution. Our approach, which is 
     correct by construction, eliminates logical hallucinations and provides a trustworthy foundation for training 
     robust reasoning models. The pipeline systematically creates high-fidelity, bi-directional (input-to-output and 
