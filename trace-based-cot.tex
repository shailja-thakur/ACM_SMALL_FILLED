...
2. Calculate mid=2\\
3. Compare arr[2] with arr[1]\\
4. Since arr[2] \textcolor{errorred}{\textbf{>}} arr[1], move \textcolor{errorred}{\textbf{right}}\\
5. Continue until left=right\\
6. Return peak index\\[0.1cm]
\textcolor{errorred}{\xmark\ Wrong comparison \& direction}
\vspace{0.1cm}
}}
&
\parbox{0.98\linewidth}{
\colorbox{gray!12}{\parbox{0.98\linewidth}{\ttfamily\scriptsize
\vspace{0.05cm}
arr = [1,3,5,4,2], left = 0, right = 4\\
mid = 2\\
arr[2] = 5, arr[3] = 4\\
5 $>$ 4, so right = 2\\
...
3. Compare arr[2] with arr[3]\\
4. Since 5 \textcolor{correctgreen}{\textbf{>}} 4, move \textcolor{correctgreen}{\textbf{left}}\\
5. Converge at index 2\\
6. Return 2 (peak value 5)\\[0.1cm]
\textcolor{correctgreen}{\cmark\ Verified by trace}
\vspace{0.1cm}
}}
}
\\
...
\end{tabular}
\vspace{-0.1cm}
\caption{LLM-generated CoT hallucinates the comparison logic and search direction, while our trace-grounded approach produces rationales verifiable against actual execution traces.}
