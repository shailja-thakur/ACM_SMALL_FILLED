...
2. Loop \textcolor{errorred}{\textbf{increments}} count\\
3. Continue until count=10\\
4. Return 10\\[0.1cm]
\textcolor{errorred}{\xmark\ Incorrect logic}
\vspace{0.1cm}
}}
&
...
\vspace{0.05cm}
count = 5\\
count: 5 $\rightarrow$ 4\\
count: 4 $\rightarrow$ 3\\
count: 3 $\rightarrow$ 2\\
count: 2 $\rightarrow$ 1\\
...
\vspace{0.1cm}
1. Initialize count=5\\
2. Loop \textcolor{correctgreen}{\textbf{decrements}} count\\
3. Continue until count=0\\
4. Return 0\\[0.1cm]
...
\end{tabular}
\vspace{-0.1cm}
\caption{LLM-generated CoT hallucinates the loop logic (claims increment instead of decrement), while our trace-grounded approach produces rationales verifiable against actual execution traces.}
