...
\begin{figure}[t!]
  ...
  \scriptsize\ttfamily
  Function: solution(\\
  \hspace*{1em}freq\textunderscore list: \\
  ...
  \begin{minipage}[t]{0.45\columnwidth}
  \scriptsize\ttfamily
  Class: HuffmanTree;\\[0.1cm]
  \textunderscore\textunderscore init\textunderscore\textunderscore(self,\\
  \hspace*{1em}freq\textunderscore list:\\
  \hspace*{2em}list[tuple[\\
  \hspace*{3em}str, int]])\\
  \hspace*{1em}-> None;\\[0.1cm]
  build\textunderscore tree(self)\\
  \hspace*{1em}-> tuple;\\[0.1cm]
  get\textunderscore encoding(self)\\
  \hspace*{1em}-> dict[str, str]
  \end{minipage}
  \\
  \bottomrule
