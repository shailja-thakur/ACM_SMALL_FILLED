...
\textbullet~Input: \texttt{freq\_list: list[tuple[str,int]]}\\
\textbullet~Output: \texttt{encoding: dict[str,str]}}
  \end{minipage}
  &
  \begin{minipage}[t]{0.46\columnwidth}
  \begin{lstlisting}[style=pythoncode, basicstyle=\ttfamily\tiny]
...
\textbullet~Methods: \texttt{\_\_init\_\_}, \texttt{build\_tree}, \texttt{get\_encoding}\\
\textbullet~Returns: None, \texttt{tree:tuple}, \texttt{codes:dict}}
  \end{minipage}
  \\
  \bottomrule
  \end{tabular}
