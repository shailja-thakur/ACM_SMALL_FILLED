...
\begin{figure}[t!]
  ...
  \begin{tcolorbox}[
      ...
      enlarge top by=0.5mm,
      enlarge bottom by=0.5mm,
      title={\scriptsize\textbf{Function Signature Format}},
      coltitle=white,
      colbacktitle=darkgray,
      boxsep=2pt,
      left=4pt,
  ...
  Function: solution(freq\_list: list[tuple[str, int]]) \\
  \hspace*{2em}-> dict[str, str]
  \end{tcolorbox}
  {\footnotesize\textbf{(a) Function signature format.}}
  ...
  \begin{tcolorbox}[
      ...
      enlarge top by=0.5mm,
      enlarge bottom by=0.5mm,
      title={\scriptsize\textbf{Class Signature Format}},
      coltitle=white,
      colbacktitle=darkgray,
      boxsep=2pt,
      left=4pt,
  ...
  Class: HuffmanTree; \_\_init\_\_(self, freq\_list: \\
  \hspace*{2em}list[tuple[str, int]]) -> None; \\
  \hspace*{1em}build\_tree(self) -> tuple; \\
  \hspace*{1em}get\_encoding(self) -> dict[str, str]
  \end{tcolorbox}
  {\footnotesize\textbf{(b) Class signature format.}}
...
\begin{figure}[t!]
  ...
  \begin{tcolorbox}[
      ...
      enlarge top by=0.5mm,
      enlarge bottom by=0.5mm,
      title={\scriptsize\textbf{Correct Test Format}},
      coltitle=white,
      colbacktitle=darkgray,
      boxsep=2pt,
      left=4pt,
  ...
  def test\_basic\_functionality(): \\
  \hspace*{1em}\# Test basic scenario \\
  \hspace*{1em}assert solution([1, 2, 3], 2) == [1]
  \end{tcolorbox}
  {\footnotesize\textbf{(a) Correct: Direct function call in assert.}}
  ...
  \begin{tcolorbox}[
      ...
      enlarge top by=0.5mm,
      enlarge bottom by=0.5mm,
      title={\scriptsize\textbf{Prohibited Test Format}},
      coltitle=white,
      colbacktitle=red,
      boxsep=2pt,
      left=4pt,
  ...
  def test\_basic\_functionality\_wrong(): \\
  \hspace*{1em}\# Variable outside assert (prohibited) \\
  \hspace*{1em}lst = [1, 2, 3] \\
  \hspace*{1em}assert solution(lst, 2) == [1]
  \end{tcolorbox}
  {\footnotesize\textbf{(b) Prohibited: Variable assignment outside assert.}}
